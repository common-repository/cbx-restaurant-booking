<?php
	 ...
	 *
	 * Futher modification by codeboxr.com team
	 */
	if ( ! class_exists( 'CBXRBooking_Settings_API' ) ):
		class CBXRBooking_Settings_API {
			...
			/*function callback_multiselect($args){
				...
				if($args['placeholder'] == '') $args['placeholder'] = esc_html__( 'Please Select', 'cbxrbooking' );
			...
			function callback_multiselect( $args ) {
				...
				if ( $args['placeholder'] == '' ) {
					$args['placeholder'] = esc_html__( 'Please Select', 'cbxrbooking' );
				}
			...
			function show_forms() {
				...
				<div class="metabox-holder">
					<?php foreach ( $this->settings_sections as $form ) { ?>
						<div id="<?php echo $form['id']; ?>" class="global_setting_group" style="display: none;">
							<form method="post" action="options.php">
								<?php
									do_action( 'cbxrbooking_setting_top_' . $form['id'], $form );
									settings_fields( $form['id'] );
									do_settings_sections( $form['id'] );
									do_action( 'cbxrbooking_setting_bottom_' . $form['id'], $form );
								?>
