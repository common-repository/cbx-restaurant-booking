<?php
	class CBXRbookingMailTemplate {
		...
		public function emailGetHeader() {
			...
			$headerimage = $this->settings_api->get_option( 'headerimage', 'cbxrbooking_email', '' );
		...
		public function emailGetFooter() {
			...
			$sitename    = get_bloginfo( 'name' ); //$config->get('sitename');
			$headerimage = $this->settings_api->get_option( 'headerimage', 'cbxrbooking_email', '' );
			$footertext  = str_replace( '{sitename}', get_bloginfo( 'name' ), $this->settings_api->get_option( 'footertext', 'cbxrbooking_email', '{sitename}' ) );
		...
		public function emailGetStyle() {
			...
			// Load colours
			$base = $this->settings_api->get_option( 'basecolor', 'cbxrbooking_email', '#557da1' );
			$bg   = $this->settings_api->get_option( 'backgroundcolor', 'cbxrbooking_email', '#f5f5f5' );

			$body      = $this->settings_api->get_option( 'bodybackgroundcolor', 'cbxrbooking_email', '#fdfdfd' );
			$headingcolor      = $this->settings_api->get_option( 'headingcolor', 'cbxrbooking_email', '#ffffff' );
			$base_text = $this->settings_api->get_option( 'bodytextcolor', 'cbxrbooking_email', '#505050' );
			$text      = $base_text;
		...
		public function htmlEmeilify( $html ) {
			...
			try {
				...
				$emogrifier = new CBXRBookingEmailEmogrifier( $html, $css );
